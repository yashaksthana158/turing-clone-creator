...
export default function EditTaskModal({ open, onClose, onUpdated, task }: EditTaskModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-[#141414] border border-gray-800 rounded-xl w-full max-w-lg p-6">
        <h2 className="text-xl font-bold text-white font-['Oxanium'] mb-4">Edit Task</h2>
